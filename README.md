...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-07 14:43`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7dc32dc5-2086-4be1-9d81-559b96ba367c.git
$ cd 7dc32dc5-2086-4be1-9d81-559b96ba367c
```
